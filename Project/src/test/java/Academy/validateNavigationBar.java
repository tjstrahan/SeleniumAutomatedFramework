...
public class validateNavigationBar extends base {
	...
	public void validateNavigationBar() {
		...
		// Assert.assertEquals(qh.courseClick().getText(), "FEATURED COURSES");
		...
		log.info("nav bar is still on page");

		// Assert.assertFalse(condition); opposite of assertTrue
	...
	public void tearDown() {
		...
		/**
		 * Setting to null so we don't have 200 drivers all sucking up memory for 200
		 * test case scenario
		 */
		driver = null;
	}
